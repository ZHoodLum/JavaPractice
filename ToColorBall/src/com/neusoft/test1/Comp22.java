...
//							user[i]=-1;
				...
				switch(level){
				case 1: print(user[k]);System.out.println("\n\n");Money.money1();wlevel=1;break;
				case 2: print(user[k]);System.out.println("\n\n");Money.money2();wlevel=2;break;
				case 3: print(user[k]);System.out.println("\n\n");Money.money3();wlevel=3;break;
				case 4: print(user[k]);System.out.println("\n\n");Money.money4();wlevel=4;break;
				case 5: print(user[k]);System.out.println("\n\n");Money.money5();wlevel=5;break;
				case 6: print(user[k]);System.out.println("\n\n");Money.money6();wlevel=6;break;
