...
public class Testwpruser {

	public static void priorwpruser(String username) throws Exception{
		// TODO Auto-generated method stub
	 Connection con=	Test8UtilProperties.getCon();
	 PreparedStatement pst= con.prepareStatement("select * from wpr where username= '"+username+"'");
