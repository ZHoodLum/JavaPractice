...
<TABLE border="0" width="809">
	...
	<TR>
		...
		<TD><a href='address_view.do?method=view&id=<bean:write name="address" property="id" scope="page"/>'><bean:message key="button.view" /></a>
		<a href='address_edit.do?method=edit&id=<bean:write name="address" property="id" scope="page"/>'><bean:message key="button.edit" /></a>
